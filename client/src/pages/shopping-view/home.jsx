...
import { SiPuma,SiZara,SiNike,SiAirchina,SiVoipdotms} from "react-icons/si";
...
const brandsWithIcon = [
  ...
  { id: "adidas", label: "Adidas", icon: PiAppStoreLogo },
  { id: "puma", label: "Puma", icon: SiPuma  },
  { id: "levi", label: "Levi's", icon: SiAirchina },
  { id: "zara", label: "Zara", icon: SiZara },
  { id: "h&m", label: "H&M", icon: TbBrandJuejin },
];
